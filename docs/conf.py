...
html_theme_options = {
    'description': 'Invenio module for the edition of records',
    ...
    'extra_nav_links': {
        'invenio-record-editor@GitHub': 'http://github.com/inveniosoftware/invenio-record-editor',
        'invenio-record-editor@PyPI': 'http://pypi.python.org/pypi/invenio-record-editor/',
    }
}
...
texinfo_documents = [
  (master_doc, 'invenio-record-editor', u'Invenio-Record-Editor Documentation',
   author, 'invenio-record-editor', 'Invenio module for the edition of records',
   'Miscellaneous'),
]
