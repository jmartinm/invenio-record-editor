...
project = u'Invenio-RecordEditor'
...
html_theme_options = {
    'description': 'Invenio module for editing JSON records.',
    ...
    'extra_nav_links': {
        'invenio-record-editor@GitHub': 'https://github.com/inveniosoftware/invenio-record-editor',
...
texinfo_documents = [
  (master_doc, 'invenio-record-editor', u'Invenio-RecordEditor Documentation',
   author, 'invenio-record-editor', 'Invenio module for editing JSON records.',
   'Miscellaneous'),
]
